...
<body>
  ...
  <div class="container">
    ...
    <form action="/editemployee/{{$data->id}}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="address" name="address"  value="{{$data->address}}"></input>
      </div>
      <div class="form-group">
        <label for="mobile">Mobile:</label>
        <input type="tel" class="form-control" maxlength="10" id="mobile" name="mobile" pattern="[0-9]{10}"  value="{{$data->mobile}}">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <select class="form-control" id="department" name="department"  onchange="updateDesignations()">
          <option value="{{$data->department_id}}">select Department</option>
          @foreach($department as $dapart)
          <option value="{{$dapart->id}}">{{$dapart->name}}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group">
        ...
        <select class="form-control" id="designation" name="designation">
         <option value="{{$data->designation_id}}">select Designation</option>
        </select> 
      </div>
      <div class="form-group">
